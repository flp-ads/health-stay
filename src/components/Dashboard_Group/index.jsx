    ...
    <Container>
      ...
      <Cards>
        <Overview>
          ...
          <CardsList>
            <OverviewItem>
              999 <span> metas </span> do grupo
            </OverviewItem>
            <OverviewItem>
              999 <span> atividades </span> do grupo
            </OverviewItem>
          </CardsList>
        </Overview>
        <MyGoals>
          ...
          {isActiveGoalAll ? (
            <>
              <Main>
                ...
                <div>
                  {isActiveGoalOnGoing && (
                    <DashboardGoalsOnGoing
                      MAX_CARDS={MAX_CARDS}
                      handleNavigation={handleNavigation}
                    />
                  )}
                  {isActiveGoalCompleted && (
                    <DashboardGoalsCompleted
                      MAX_CARDS={MAX_CARDS}
                      handleNavigation={handleNavigation}
                    />
                  )}
          ...
          <Main>
            <SubMenu>
              {isActivitiesAll ? (
                groups
                  .slice(0, MAX_CARDS)
                  .map((group) => <ActivitiesCard group={group.activities} />)
              ) : (
